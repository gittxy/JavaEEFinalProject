    ...
    <section id="content" class="container">
        <div class="block-area" id="basic">
            ...
            <form action="${pageContext.request.contextPath}/SubmitHomeworkServlet" role="form">
                ...
                <div class="form-group">
                    <label for="hwContent">作业要求</label>
            ...
            <form action="/SSubmit.jsp" method=post >
                <a href="${pageContext.request.contextPath}/submit1?sId=${pageContext.request.getParameter("sId")}"><input type="button" value="返回" class="btn btn-sm m-t-10"></a>
            </form>
