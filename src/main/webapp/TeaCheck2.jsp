            ...
            <div class="table-responsive overflow">
                <table class="tile table table-bordered table-striped">
                    ...
                    <tr>
                        ...
                        <td><%=sh.getScore()%></td>
                        <td><a href="${pageContext.request.contextPath}/CheckHomework2?sId=<%=sh.getStudentId()%>&&hwId=<%=sh.getHomeworkId()%>&&hwTitle=<%=sh.getHomeworkTitle()%>&&hwContent=<%=sh.getHomeworkContent()%>"><input type="button" value="检查" class="btn btn-sm m-t-10"></a></td>
                ...
                <form action="${pageContext.request.contextPath}/Check" method=post >
                    <input type="submit" class="btn btn-sm m-t-10" value="返回" /></th>
                </form>
            </div>
        </div>
