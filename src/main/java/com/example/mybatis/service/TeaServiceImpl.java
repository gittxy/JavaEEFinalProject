...
public class TeaServiceImpl implements TeaService {
    ...
    @Autowired
    public TeaServiceImpl(HomeworkDao homeworkDao, StudentDao studentDao, StudentHomeworkDao studentHomeworkDao, TeacherDao teacherDao) {
    ...
    public boolean login(HttpServletRequest req) {
        ...
        List<Teacher> list=teacherDao.find3(t.getId(),t.getPW());
    ...
    @Override
    public List<StudentHomework> find4(Long homeworkId) {
        return studentHomeworkDao.find4(homeworkId);
    }
}