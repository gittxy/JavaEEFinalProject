...
public class StuServiceImpl implements StuService {
    ...
    @Autowired
    public StuServiceImpl(HomeworkDao homeworkDao, StudentDao studentDao, StudentHomeworkDao studentHomeworkDao) {
    ...
    @Override
    public boolean editHomework(Long homeworkId, Long num) {

        return homeworkDao.editHomework(homeworkId,num);
    }
